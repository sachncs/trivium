...
2. Create a topic branch off `master` (linear history).
3. Make focused commits with clear messages.
4. Ensure `pytest -q`, `ruff check .`, `ruff format --check .`,
   and `mypy trivium` all pass.
5. Use the [PR template](https://github.com/sachncs/trivium/blob/master/.github/PULL_REQUEST_TEMPLATE.md).
6. Push the branch and open a PR targeting `master`.

By submitting a PR, you agree to follow the [Code of Conduct](https://github.com/sachncs/trivium/blob/master/CODE_OF_CONDUCT.md).
